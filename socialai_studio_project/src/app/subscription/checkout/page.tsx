            ...
            <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow">
              <div className="mb-6">
                ...
                <div className="mt-4 flex justify-between">
                  <div>
                    <p className="text-lg font-medium text-gray-900">{plan.charAt(0).toUpperCase() + plan.slice(1)} Plan</p>
                    <p className="text-sm text-gray-500">{billing === 'annual' ? 'Annual billing (20% discount)' : 'Monthly billing'}</p>
                  </div>
                  <p className="text-lg font-medium text-gray-900">${price}/mo</p>
                </div>
                {billing === 'annual' && (
                  <div className="mt-4 p-3 bg-green-50 rounded-md">
                    <p className="text-sm text-green-700">You're saving 20% with annual billing!</p>
                  </div>
                )}
              </div>
